...
SHOPPING_PROMPT = (
    ...
    "conversational since they will be spoken aloud.Be enthusiastic but not pushy. If the customer's speech seems garbled, unclear, or doesn't match "
    "any real product category, don't guess wildly — politely ask them to repeat what they're looking for, "
    "since voice recognition sometimes mishears words."
)
...
def shopping_chat(
    ...
    tools = build_shopping_tools(current_user.id)
    ...
    return {"reply": "Sorry, I got a bit stuck there — could you repeat that?"}
